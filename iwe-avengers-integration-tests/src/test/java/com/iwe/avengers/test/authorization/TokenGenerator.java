...
public class TokenGenerator {
	...
	public String getToken() {
		...
		final String clientId = "62ep1si92rp04tglcd4otelete";
		final String userPoolId = "us-west-2_Hw25Ifugn";
		...
		initiateAuthRequest.addAuthParametersEntry("USERNAME", "carranca");
